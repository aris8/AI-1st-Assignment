...
public boolean isSwapValid2(int i, int j, int p) {
	
	if( p == 1){
		if (a1[i][j].getLesson().getLes_name().equals("----")) return false;
		if (a1[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (a1[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (a1[i+1][j].getLesson().getLes_name().equals("----") && a1[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
			return isSwapValid(i,j,p);
		}
	}
	else if( p == 2){
		if (a2[i][j].getLesson().getLes_name().equals("----")) return false;
		if (a2[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (a2[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (a2[i+1][j].getLesson().getLes_name().equals("----") && a2[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (a3[i][j].getLesson().getLes_name().equals("----")) return false;
		if (a3[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (a3[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (a3[i+1][j].getLesson().getLes_name().equals("----") && a3[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (b1[i][j].getLesson().getLes_name().equals("----")) return false;
		if (b1[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (b1[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (b1[i+1][j].getLesson().getLes_name().equals("----") && b1[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (b2[i][j].getLesson().getLes_name().equals("----")) return false;
		if (b2[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (b2[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (b2[i+1][j].getLesson().getLes_name().equals("----") && b2[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (b3[i][j].getLesson().getLes_name().equals("----")) return false;
		if (b3[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (b3[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (b3[i+1][j].getLesson().getLes_name().equals("----") && b3[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (c1[i][j].getLesson().getLes_name().equals("----")) return false;
		if (c1[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (c1[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (c1[i+1][j].getLesson().getLes_name().equals("----") && c1[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (c2[i][j].getLesson().getLes_name().equals("----")) return false;
		if (c2[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (c2[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (c2[i+1][j].getLesson().getLes_name().equals("----") && c2[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
		...
		if (c3[i][j].getLesson().getLes_name().equals("----")) return false;
		if (c3[row_x][row_y].getLesson().getLes_name().equals("----")) {
			if (i == 6) {return true;}
			else if ( i == 5) {
				if (c3[i+1][j].getLesson().getLes_name().equals("----")) return true;
			}
			else if (i == 4) {
				if (c3[i+1][j].getLesson().getLes_name().equals("----") && c3[i+2][j].getLesson().getLes_name().equals("----")) return true;
			} else {
				return false;
			}
		} else {
	...
	public Collection<? extends State> getChildren() throws FileNotFoundException, UnsupportedEncodingException, CloneNotSupportedException {
		...
		State s = new State(this.a1,this.a2,this.a3,this.b1,this.b2,this.b3,this.c1,this.c2,this.c3);
		for(int p = 1;p <= 9;p++){
			
			for(int i =0; i < 7;i++){
				for(int j = 0; j < 5;j++){
					if( p == 1 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
						child = new State(this.a1,this.a2,this.a3,this.b1,this.b2,this.b3,this.c1,this.c2,this.c3);
						s = new State(this.a1,this.a2,this.a3,this.b1,this.b2,this.b3,this.c1,this.c2,this.c3);
					}
					else if( p == 2 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 3 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 4 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 5 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 6 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 7 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 8 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
					...
					else if( p == 9 && isSwapValid2(i,j,p)){
						child.swap(i,j,p);
						child.euristic();
						s.euristic();
						if (s.getScore() > child.getScore()) children.add(child);
